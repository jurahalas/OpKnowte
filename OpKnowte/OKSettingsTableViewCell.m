...
@implementation OKSettingsTableViewCell
...
-(void) setCellUserIntaractionDisabled {
    ...
    self.settingsIcon.alpha = 0.3f;
    self.settingsLabel.textColor = [UIColor colorWithWhite:1 alpha:.3f];
}
-(void) setCellUserIntaractionEnabled {
    
    [self setUserInteractionEnabled:YES];
    self.settingsIcon.alpha = 1.f;
    self.settingsLabel.textColor = [UIColor colorWithWhite:1 alpha:1.f];
