...
#import "OKDataCaptureTableViewCell.h"

@implementation OKDataCaptureTableViewCell
...
-(void) setCellUserIntaractionDisabled {
    ...
    self.dataCaptureIcon.alpha = 0.3f;
    self.dataCaptureLable.textColor = [UIColor colorWithWhite:1 alpha:.3f];
}
-(void) setCellUserIntaractionEnabled {
    
    [self setUserInteractionEnabled:YES];
    self.dataCaptureIcon.alpha = 1.f;
    self.dataCaptureLable.textColor = [UIColor colorWithWhite:1 alpha:1.f];
