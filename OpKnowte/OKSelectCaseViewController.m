...
-(void)setupData
{
    ...
    if (self.fromSettings) {
        [[OKTemplateManager instance]getTemplate:[OKUserManager instance].currentUser.userID withProcedureID:[OKProceduresManager instance].selectedProcedure.procedureID handler:[self getTemplateHandler]];
